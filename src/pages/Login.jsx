                    ...
                    <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white ' >
                        <div className='max-w-[320px] mx-auto py-16 '  >
                            ...
                            <form className='w-full flex flex-col py-4 ' >
                                <input className='p-3 my-2 bg-gray-700 rounded outline-red-600 ' type="email" placeholder='Email' autoComplete='email' />
                                <input className='p-3 my-2 bg-gray-700 rounded outline-red-600 ' type="password" placeholder='Password' autoComplete='current-password' />
